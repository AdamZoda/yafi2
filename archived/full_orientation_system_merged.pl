...
% =======================================================
% DATA MERGE - VERSION ABSOLUE (Enriched)
% =======================================================

institution(emsi_casablanca, 'EMSI Casablanca', casablanca, private, engineering, 2500).
institution(emsi_rabat, 'EMSI Rabat', rabat, private, engineering, 1500).
institution(emsi_marrakech, 'EMSI Marrakech', marrakech, private, engineering, 1200).
institution(emsi_tangier, 'EMSI Tanger', tanger, private, engineering, 800).
institution(emsi_fes, 'EMSI Fès', fes, private, engineering, 1000).
institution(emsi_agadir, 'EMSI Agadir', agadir, private, engineering, 700).
institution(emsi_kenitra, 'EMSI Kénitra', kenitra, private, engineering, 600).
institution(emsi_meknes, 'EMSI Meknès', meknes, private, engineering, 500).
institution(emsi_nador, 'EMSI Nador', nador, private, engineering, 400).
institution(emsi_oujda, 'EMSI Oujda', oujda, private, engineering, 450).
